...
public class AddPostFragmentBindingImpl extends AddPostFragmentBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.addPost, 7);
    }
    // views
    @NonNull
    ...
    private androidx.databinding.InverseBindingListener postandroidTextAttrChanged = new androidx.databinding.InverseBindingListener() {
        @Override
        public void onChange() {
            // Inverse of posts.post
            //         is posts.setPost((java.lang.String) callbackArg_0)
            java.lang.String callbackArg_0 = androidx.databinding.adapters.TextViewBindingAdapter.getTextString(post);
            // localize variables for thread safety
            // posts != null
            boolean postsJavaLangObjectNull = false;
            // posts.post
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            androidx.databinding.adapters.ImageViewBindingAdapter.setImageUri(this.addImage, postsImage);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.addPostTitle, postsTitle);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.post, postsPost);
        }
        if ((dirtyFlags & 0x2L) != 0) {
            ...
            androidx.databinding.adapters.TextViewBindingAdapter.setTextWatcher(this.post, (androidx.databinding.adapters.TextViewBindingAdapter.BeforeTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.OnTextChanged)null, (androidx.databinding.adapters.TextViewBindingAdapter.AfterTextChanged)null, postandroidTextAttrChanged);
        }
    }

...
public class PostDetailFragmentDirections {
  ...
  @NonNull
  public static ActionPostDetailFragmentToHomeFragment actionPostDetailFragmentToHomeFragment() {
    return new ActionPostDetailFragmentToHomeFragment();
  }

  public static class ActionPostDetailFragmentToHomeFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionPostDetailFragmentToHomeFragment() {
    }

    @NonNull
    public ActionPostDetailFragmentToHomeFragment setPost(@Nullable Post post) {
    ...
    public int getActionId() {
      return R.id.action_postDetailFragment_to_homeFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionPostDetailFragmentToHomeFragment that = (ActionPostDetailFragmentToHomeFragment) object;
    ...
    public String toString() {
      return "ActionPostDetailFragmentToHomeFragment(actionId=" + getActionId() + "){"
          + "post=" + getPost()
          + "}";
    }
  }

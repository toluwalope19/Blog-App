...
public class PostDetailFragmentArgs implements NavArgs {
  ...
  private PostDetailFragmentArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static PostDetailFragmentArgs fromBundle(@NonNull Bundle bundle) {
    PostDetailFragmentArgs __result = new PostDetailFragmentArgs();
  ...
  public boolean equals(Object object) {
    ...
    PostDetailFragmentArgs that = (PostDetailFragmentArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(PostDetailFragmentArgs original) {
    ...
    public PostDetailFragmentArgs build() {
      PostDetailFragmentArgs result = new PostDetailFragmentArgs(arguments);
      return result;
    }

...
public class AddPostFragmentDirections {
  ...
  @NonNull
  public static ActionAddPostFragmentToHomeFragment actionAddPostFragmentToHomeFragment() {
    return new ActionAddPostFragmentToHomeFragment();
  }

  public static class ActionAddPostFragmentToHomeFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionAddPostFragmentToHomeFragment() {
    }

    @NonNull
    public ActionAddPostFragmentToHomeFragment setPost(@Nullable Post post) {
    ...
    public int getActionId() {
      return R.id.action_addPostFragment_to_homeFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionAddPostFragmentToHomeFragment that = (ActionAddPostFragmentToHomeFragment) object;
    ...
    public String toString() {
      return "ActionAddPostFragmentToHomeFragment(actionId=" + getActionId() + "){"
          + "post=" + getPost()
          + "}";
    }
  }
